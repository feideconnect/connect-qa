    ...
    "init": function() {
        ...
        if (argv.set) {
            if (allconfig.sets[argv.set]) {
                extend(sconfig, allconfig.sets[argv.set], {
                    "set": argv.set
                });
            } else {
            ...
            extend(sconfig, allconfig.sets[allconfig.default], {
                "set": allconfig.default
            });
        }

        this.sconfig = sconfig;

        this.sconfig.password = process.env.PASSWORD || this.sconfig.password;
